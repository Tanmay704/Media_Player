...
//            time slider
    ...
    void play(ActionEvent event) {
        ...
        try {
            ...
            if (status == MediaPlayer.Status.PLAYING) {
                ...
                playBtn.setGraphic(new ImageView(new Image(new FileInputStream("src/images/play.png"))));
            } else {
                player.play();

                playBtn.setGraphic(new ImageView(new Image(new FileInputStream("src/images/pause.png"))));
            }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        try {
            playBtn.setGraphic(new ImageView(new Image(new FileInputStream("src/images/play.png"))));
            preBtn.setGraphic(new ImageView(new Image(new FileInputStream("src/images/backward10sec.png"))));
            nextBtn.setGraphic(new ImageView(new Image(new FileInputStream("src/images/forward10sec.png"))));
